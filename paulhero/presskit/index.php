...
<html>
	<head>
		...
		<link rel="shortcut icon" href="images/icono_crios.ico">
...
echo '					<div class="uk-grid">
						<div class="uk-width-medium-2-6">
							...
							<p>
								...
								<a href="http://'. parseLink(COMPANY_WEBSITE) .'" target="_blank">'. parseLink(COMPANY_WEBSITE) .'</a><br/>
...
if( file_exists('images/logo.png') ) {
	echo '<div class="uk-width-medium-1-2"><a href="images/logo.png"><img src="images/logo.png" alt="logo" /></a></div>';	echo '<div class="uk-width-medium-1-2"><a href="images/logo2.png"><img src="images/logo2.png" alt="logo" /></a></div>';
}
