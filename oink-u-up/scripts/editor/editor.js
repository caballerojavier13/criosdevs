$(function () {
    ...
    function speedTest(callback) {
        ...
        img.src = "content/misc/speed_test.jpg";
    }
    ...
    function initilize() {
        ...
        if (restore && localStorage['card'] != null) {
            ...
            if (localConfig.length > 0) {
                ...
                if(localConfig[0].properties.length < 1){

                    localConfig[0].properties.push({
                        type: "Frame",
                        value:"frame/oink.png"
                    });
                }
            ...
            cardConfig[0].properties = [];

            cardConfig[0].properties.push({
                type: "Frame",
                value:"frame/oink.png"
            });
